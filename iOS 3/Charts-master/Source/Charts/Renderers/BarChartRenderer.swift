...
open class BarChartRenderer: BarLineScatterCandleBubbleRenderer
{
    ...
    open override func drawData(context: CGContext, drawCustomText: Bool = false)
    {
        self.drawCustomText = drawCustomText
                ...
                if !dataSet.isStacked
                {
                    for j in 0 ..< Int(ceil(Double(dataSet.entryCount) * animator.phaseX))
                    {
                        ...
                        if dataSet.isDrawValuesEnabled
                        {
                            drawValue(
                                context: context,
                                value: self.drawCustomText == true ? e.text : formatter.stringForValue(
                                    val,
                                    entry: e,
    ...
    //getValueWithCustomFormat
    func getValueWithFormat(value: Double) -> String
    {
        if(value < 80)
        {
            return "D"
