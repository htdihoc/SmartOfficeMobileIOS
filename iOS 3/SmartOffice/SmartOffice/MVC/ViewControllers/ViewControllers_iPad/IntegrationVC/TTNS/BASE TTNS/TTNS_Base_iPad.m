...
@interface TTNS_Base_iPad ()<TTNS_NavBase_iPadDelegate, WYPopoverControllerDelegate>{
...
- (void)viewDidLayoutSubviews
{
    ...
    if(_nav_iPad == nil)
    {
        ...
        [_nav_iPad addButtons:self.TTNS_buttonTitles margin:20 fontSize:14];
    }
}
...
- (void)addNav
{
    _nav_iPad = [[TTNS_NavBase_iPad alloc] initWithFrame:CGRectMake(0, 0, 100, 100)];
...
//        popOverController.popoverLayoutMargins = UIEdgeInsetsMake(44, self.view.frame.size.width-260, self.view.frame.size.height-400, 16);
