...
- (void)setup {
    ...
    self.searchview.searchBar.layer.borderWidth                    = 1;
    self.searchview.searchBar.layer.borderColor                    = AppColor_BorderForView.CGColor;
    ...
    self.lbl_Badge.clipsToBounds = YES;
    self.lbl_Badge.layer.cornerRadius = 8;
}
