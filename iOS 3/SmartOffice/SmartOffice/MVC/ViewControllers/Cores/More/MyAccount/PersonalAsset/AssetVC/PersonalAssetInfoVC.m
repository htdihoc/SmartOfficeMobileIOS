...
@interface PersonalAssetInfoVC ()

@end

@implementation PersonalAssetInfoVC

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view from its nib.
    self.navigationController.navigationBar.tintColor = [UIColor whiteColor];
    [self.tbPersonalAssetInfo registerNib:[UINib nibWithNibName:@"PersonalAssetInfoCell" bundle:nil]forCellReuseIdentifier:[PersonalAssetInfoCell cellIdentifier]];
    //[self.segChangeAsset addTarget:self action:@selector(segChangeView:) forControlEvents:UIControlEventValueChanged];
