...
- (void)generateData
{
    ...
    for(int i = 0; i < 10; i++)
    {
        ...
        NSString *content = [NSString stringWithFormat:@"Nội dung ra ngoài %d", i];
        NSString *time = [NSString stringWithFormat:@"14/%d/2016 - 29/5/2017", i];
...
- (void)showDismissTimeKeeping
{
    ...
    [self showAlert:content title:@"Từ chối phê duyệt" leftButtonTitle:@"Đóng" rightButtonTitle:@"Từ chối" leftHander:nil rightHander:nil];
}
/*
