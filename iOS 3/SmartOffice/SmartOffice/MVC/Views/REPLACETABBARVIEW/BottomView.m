...
- (void)disableButton:(BOOL)isDisableButton
{
    if (!self.leftBtn.isHidden) {
        self.leftBtn.hidden = isDisableButton;
        self.rightBtn.hidden = isDisableButton;
    }
...
- (void)initCustom
{
    if(self.leftBtnAttribute)
    {
        ...
        [self.leftBtn addTarget:self action:@selector(selectLeftButton) forControlEvents:UIControlEventTouchUpInside];
    ...
    if(self.rightBtnAttribute)
    {
        ...
        [self.rightBtn addTarget:self action:@selector(selectRightButton) forControlEvents:UIControlEventTouchUpInside];
...
- (void)selectLeftButton {
    [self.delegate didselectLeftButton];
}
