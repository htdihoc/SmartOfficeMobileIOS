...
#define New_Storyboard(storyboardName) [UIStoryboard storyboardWithName:storyboardName bundle:nil]
#define initViewController(Class, identifier) (Class *)[storyboard instantiateViewControllerWithIdentifier:identifier]
